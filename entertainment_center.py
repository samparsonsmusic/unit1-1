...
space_is_the_place = Movie("Space is the Place",
        "https://www.residentadvisor.net/images/events/flyer/2013/7/de-0720-496345-front.jpg",
...
moon = Movie("Moon",
        "https://static.rogerebert.com/uploads/movie/movie_poster/moon-2009/large_uXvYBgbuJhySVqshcgrfeqQkK7y.jpg",
        "https://www.youtube.com/watch?v=twuScTcDP_Q")

event_horizon = Movie("Event Horizon",
        "http://img.moviepostershop.com/event-horizon-movie-poster-1997-1020255488.jpg",
        "https://www.youtube.com/watch?v=OVlnER8SxfQ")

movies_list = [space_is_the_place, europa_report, alien, blade_runner, moon, event_horizon]
